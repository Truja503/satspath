...
function __wbg_adapter_48(arg0, arg1, arg2) {
    wasm._dyn_core_9b3796e30d99ddb7___ops__function__FnMut_______Output______as_wasm_bindgen_1de90c3e2ed2ef27___closure__WasmClosure___describe__invoke___wasm_bindgen_1de90c3e2ed2ef27___JsValue_____(arg0, arg1, addHeapObject(arg2));
}
...
export function sign_profile_json(profile_json, secret_key_hex) {
    ...
    try {
        ...
        wasm.sign_profile_json(retptr, ptr0, len0, ptr1, len1);
...
export function canonical_profile_json(profile_json) {
    try {
        ...
        const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.canonical_profile_json(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export function fingerprint_pubkey(pubkey_hex) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.fingerprint_pubkey(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function topic_for_alias(alias) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.topic_for_alias(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v2 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1, 1);
...
function __wbg_adapter_138(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_1de90c3e2ed2ef27___convert__closures__invoke2_mut___wasm_bindgen_1de90c3e2ed2ef27___JsValue__wasm_bindgen_1de90c3e2ed2ef27___JsValue_____(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

const Bip353ResolverFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_bip353resolver_free(ptr >>> 0));
/**
...
export class Bip353Resolver {
    ...
    free() {
        ...
        wasm.__wbg_bip353resolver_free(ptr);
    }
    /**
    * @param {string} alias
...
const ChainResolverFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chainresolver_free(ptr >>> 0));
/**
...
export class ChainResolver {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_chainresolver_free(ptr);
    }
    /**
...
const HttpsWellKnownResolverFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_httpswellknownresolver_free(ptr >>> 0));
/**
...
export class HttpsWellKnownResolver {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_httpswellknownresolver_free(ptr);
    }
    /**
    * @param {string} alias
    * @returns {Promise<string>}
...
const IdentityKeypairFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_identitykeypair_free(ptr >>> 0));
/**
*/
export class IdentityKeypair {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_identitykeypair_free(ptr);
    }
    /**
    * @returns {string}
    */
    get pubkey_hex() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.identitykeypair_pubkey_hex(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get secret_key_hex() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.identitykeypair_secret_key_hex(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
const LocalRegistryFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_localregistry_free(ptr >>> 0));
/**
...
export class LocalRegistry {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_localregistry_free(ptr);
    }
    /**
    * @param {string} alias
    * @returns {Promise<string>}
    ...
    */
    add_profile(profile_json) {
        try {
            ...
            const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.localregistry_add_profile(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    list_profiles() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.localregistry_list_profiles(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
const NostrNip05ResolverFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_nostrnip05resolver_free(ptr >>> 0));
/**
...
export class NostrNip05Resolver {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_nostrnip05resolver_free(ptr);
    }
    /**
    * @param {string} alias
    * @returns {Promise<string>}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper2249 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 807, __wbg_adapter_48);
        return addHeapObject(ret);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('satspath_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

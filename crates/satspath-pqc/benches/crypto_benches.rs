...
use satspath_pqc::hybrid_sig::{HybridSigningKeyPair, generate_hybrid_keypair, hybrid_sign, hybrid_verify};
...
criterion_group!(benches, bench_hybrid_keygen, bench_hybrid_sign, bench_hybrid_verify);
